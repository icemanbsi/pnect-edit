		...
		return array(
			'elements' => array(			
				...
				'fileSizeLimit' => array('type' => 'text', 'hint' => $this->t('MB'),
					...
					'class' => 'short', 'layout' => "{label}\n<span class='hintInlineAfter'>{input}\n{hint}</span>"),
				'fileOriginalResize' => array('type' => 'text', 'label' => $this->t('Resize Uploaded Image To'),
					'hint' => $this->t('ex.: 200'), 'class' => 'short'),
				'fileThumbnailResize' => array('type' => 'text', 'label' => $this->t('Thumbnail Size'),
					'hint' => $this->t('ex.: 60'), 'class' => 'short'),
